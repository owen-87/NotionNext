...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'magzine', // 当前站点固定使用 magzine，确保公开页面可在服务端直接渲染
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.funshow.top', // 网站规范地址
  OG_IMAGE: process.env.NEXT_PUBLIC_OG_IMAGE || '/bg_image.jpg', // 默认社交分享图
